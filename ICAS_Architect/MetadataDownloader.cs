...
<body>";
        ...
        internal List<EntityMetadata> allEntitiesMetadata;
        ...
        internal ERInformation GetERInformation()
        {
            return ERInformationUtil.GetERInformationForAllEntities(OrganizationUrl, allEntitiesMetadata);
        }
